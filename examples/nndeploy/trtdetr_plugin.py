...
class TRTDETRNode(nndeploy.dag.Node):
    def __init__(
        self,
        name,
        ...
        super().set_key("nndeploy.trtdetr.TRTDETR")
        super().set_desc("TensorRT-DETR Node")
    ...
    def init(self):
        try:
            ...
            print(f"TRTDETR Node Init Failed: {e}")
    ...
    def run(self):
        try:
            ...
            print(f"TRTDETR Node Run Failed: {e}")
            return nndeploy.base.Status.error()
    ...
    def deserialize(self, target: str):
        try:
            ...
            print(f"TRTDETR Node Deserialize Failed: {e}")
            return nndeploy.base.Status.error()
...
class VisualizerNode(nndeploy.dag.Node):
    def __init__(
        ...
        super().__init__(name, inputs, outputs)
        super().set_key("nndeploy.trtdetr.Visualizer")
        super().set_desc("TensorRT-DETR Visualizer Node")
        self.set_input_type(np.ndarray)
...
class TRTDETRNodeCreator(nndeploy.dag.NodeCreator):
    def __init__(self):
        super().__init__()
    ...
    def create_node(
        ...
        self.node = TRTDETRNode(name, inputs, outputs)
        return self.node
...
trtdetr_node_creator = TRTDETRNodeCreator()
visualizer_node_creator = VisualizerNodeCreator()

nndeploy.dag.register_node("nndeploy.trtdetr.TRTDETR", trtdetr_node_creator)
nndeploy.dag.register_node("nndeploy.trtdetr.Visualizer", visualizer_node_creator)
