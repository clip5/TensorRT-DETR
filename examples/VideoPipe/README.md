...
本示例以 YOLO11n 模型为例，演示如何将 TensorRT-DETR 的 Deploy 模块集成到 [VideoPipe](https://github.com/sherlockchou86/VideoPipe) 中进行视频分析。
...
> [!IMPORTANT]
>
> 使用项目配套的 `trtdetr-export` 工具包，导出适用于该项目推理的 ONNX 模型并构建为 TensorRT 引擎。
